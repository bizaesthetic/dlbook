...
# $$
# 
# Now, $$a_1 = f_1(z_1) = f_1(\begin{bmatrix}
# 4.3 & 5.3
# \end{bmatrix})$$
# 
# $$a_1 = \begin{bmatrix}
...
# $$
# 
# Now, $$a_2 = f_2(z_2) = f_2(\begin{bmatrix}
# 2.086 & 1.389
# \end{bmatrix})$$
# 
# $$a_2 = \begin{bmatrix}
...
# The solution (in non-vectorized format) for the given network can be found [here](https://www.anotsorandomwalk.com/backpropagation-example-with-numbers-step-by-step/) (link to an external website). On comparing we find our solution is in complete agreement with that solution! We can easily extend this vectorized format for multiple hidden layers as well as for a batch dataset. You can also repeat this update for many epochs. Oh sorry! Let me introduce **batches, epochs, iterations, parameters, hyper-parameters, update law, etc** in the next section. Complete code is shown below
