...
#     $$O_h = \left \lfloor \frac{N_h - K_h + p_h}{s_h} \right \rfloor + 1$$ <br>
...
# 
# Don't worry, in our [forward propagation code](https://pythonandml.github.io/dlbook/content/convolutional_neural_networks/forward_propagation_cnn.html), which we will develop from scratch in a step by step manner, we will not be using any for loops and the code will be fully vectorized (written in just few lines using only numpy)!
